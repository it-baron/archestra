...
/**
 * Search Archestra MCP catalog with built-in servers
 */
export const searchArchestraCatalog = <ThrowOnError extends boolean = false>(options?: Options<SearchArchestraCatalogData, ThrowOnError>) => {
    return (options?.client ?? client).get<SearchArchestraCatalogResponses, SearchArchestraCatalogErrors, ThrowOnError>({
...
/**
 * Get Archestra catalog server by name
 */
export const getArchestraCatalogServer = <ThrowOnError extends boolean = false>(options: Options<GetArchestraCatalogServerData, ThrowOnError>) => {
    return (options.client ?? client).get<GetArchestraCatalogServerResponses, GetArchestraCatalogServerErrors, ThrowOnError>({
...
/**
 * Get all Archestra catalog categories
 */
export const getArchestraCatalogCategories = <ThrowOnError extends boolean = false>(options?: Options<GetArchestraCatalogCategoriesData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetArchestraCatalogCategoriesResponses, GetArchestraCatalogCategoriesErrors, ThrowOnError>({
